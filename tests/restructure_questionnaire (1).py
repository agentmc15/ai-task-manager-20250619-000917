...
4. Replace hardware_entry.columns with Linda's 5-column spec
5. Full edges-array rewrite to the new 13-question linear flow
...
# ---------- step 4: replace hardware columns ----------
...
def replace_hardware_columns(questions: list[dict]) -> bool:
    ...
    """
    _section("Step 4: Replace hardware_entry columns")
...
def rewrite_edges(questions: list[dict]) -> list[dict]:
    ...
    """
    _section("Step 5: Rewrite edges to target flow order")
